      ...
      <div className="w-full max-w-md rounded-2xl border border-zinc-800 bg-zinc-950 p-6 space-y-5 shadow-2xl">
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-center gap-3">
            <div className="h-11 w-11 rounded-xl bg-amber-400/10 flex items-center justify-center text-amber-400">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-400 mt-0.5">{message || 'Veuillez patienter…'}</p>
            </div>
          </div>
          <button
            type="button"
...
export function PrivateGalleryDownloadActions({
  ...
  return (
    <div className="flex flex-wrap gap-2 shrink-0">
      <Button variant="gold" size="sm" onClick={onDownloadZip} disabled={downloading || photoCount === 0}>
